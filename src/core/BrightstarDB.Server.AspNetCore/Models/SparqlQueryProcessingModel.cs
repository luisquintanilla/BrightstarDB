...
public class SparqlQueryProcessingModel : ISparqlResultModel
{
    ...
    public ulong CommitId => _commitId;
    public bool HasCommitId => CommitId > 0;
    public SparqlRequestObject SparqlRequest => _sparqlRequest;

    public SparqlResultsFormat OverrideResultsFormat { get; set; } = null!;
    public RdfFormat OverrideGraphFormat { get; set; } = null!;

    public SerializableModel ResultModel { get; set; }
    public bool HasErrorMessage => !String.IsNullOrEmpty(ErrorMessage);
    public string ErrorMessage { get; private set; } = String.Empty;
    public bool HasFormattedResults { get; private set; }
    public string RawResults { get; private set; } = String.Empty;
