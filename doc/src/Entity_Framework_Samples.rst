...
.. note::
   ...
   The "Adding Linked Data Support" and OData tutorials from BrightstarDB 1.x
   have been removed. OData support is no longer included in BrightstarDB 2.0.
   For programmatic access to BrightstarDB stores, use the embedded API,
   HTTP REST API, or SPARQL endpoints.
